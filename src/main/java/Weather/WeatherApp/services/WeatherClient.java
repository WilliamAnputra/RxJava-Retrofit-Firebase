...
import Weather.WeatherApp.model.WeatherDetails;
import Weather.WeatherApp.model.WeatherFullDetails;
...
public class WeatherClient {
   ...
   public List<WeatherData> weatherDataConverter(WeatherListModel weatherListModel, final Firebase reference) {
      ...
      for (WeatherFullDetails
              weatherFullDetails : weatherListModel.fullDetailsList) {
